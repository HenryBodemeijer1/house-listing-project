  ...
  <div class="container">
    <div>
      ...
      <form @submit.prevent="postData" method="post">
        ...
        <button type="submit" class="create-listing-button">Post</button>
...
export default {
  ...
  methods: {
    postData() {
      axios.post("https://api.intern.d-tt.nl/api/houses/", this.posts, {
        headers: {
      ...
      .catch(error => {
        ...
        this.errorMessage = 'Failed to create listing. Please try again later.';
      });
    },
    handleImageUpload(event) {
      ...
      if (file) {
        ...
        this.posts.imageURL = URL.createObjectURL(file); // Set imageURL immediately
      }
    },
    returnToOverview() {
